...
rf_1 = RFECV(RandomForestClassifier(n_estimators = 100, max_depth = 4), 20, 200, cv = 5)
...
np.random.seed(0)
sclf = StackingCVClassifier(classifiers = [lgbm_1, xgb_1, rf_1, svc_1, lr_1], 
                            use_probas = True,
...
model_1_ens_lr.to_csv(r'D:/Python/data/DontOverFit/StackingClassifier-5-8184.csv', index = False)
